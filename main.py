...
def insertData():
    ...
    employee_salary = emp_salary.get()
...
def light_theme():
    ...
    salarylbl.config(bg='#C9FFF8', fg='#323739')
    ...
    salaryEnt.config(bg='#B2D4DF', fg='#131414')
...
def dark_theme():
    ...
    salarylbl.config(bg='#6A6A6A', fg='white')
    ...
    salaryEnt.config(bg=ent_color, fg='#131414')
...
def help_window():
    ...
    help_win.title('Employee Administration System')
...
search_btn = tk.Button(search_frm, width=12, padx=2, pady=2,
                       font=("Arial Greek", 10), bd=1, text="☥ Search", bg="#56545D", fg='white', relief=tk.RIDGE,
...
deleteEmployee = tk.Button(buttons_box, width=12, padx=2, pady=2,
                           font=("Arial Greek", 12), bd=1, text="〤 Delete", bg="#6C6354", fg='white', relief=tk.RIDGE,
                           command=delete_employee)
deleteEmployee.place(x=515, y=20)

show_data = tk.Button(buttons_box, width=12, padx=2, pady=2,
                      font=("Arial Greek", 12), bd=1, text="⎋ Show Data", bg="#416853", fg='white', relief=tk.RIDGE,
                      command=get_data)
